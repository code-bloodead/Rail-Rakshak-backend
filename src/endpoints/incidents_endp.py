...
async def create_incident_by_user(image: UploadFile = File(...), title: str = Form(...), description: str = Form(...), type: str = Form(...), station_name: str = Form(...), location: str = Form(...), source: str = Form(...)):
    try:
